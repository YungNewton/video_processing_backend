...
def upload_file():
    try:
        ...
        print(f"Text file: {text_file.filename}")  # Debug print
        print(f"Video file: {video_file.filename}")  # Debug print
        print(f"Voice ID: {voice_id}, API Key: {api_key}, Speed: {speed}, Set Speed Up: {set_speed_up}")  # Debug print
        ...
        with TemporaryDirectory() as temp_dir:
            ...
            print(f"Saved text file to {text_path}")  # Debug print
            print(f"Saved video file to {video_path}")  # Debug print
            ...
            print(f"New timestamps SRT: {new_timestamps_srt}")  # Debug print
            print(f"Old timestamps SRT: {old_timestamps_srt}")  # Debug print
            ...
            print(f"Zipped SRT files: {zip_path}")  # Debug print
